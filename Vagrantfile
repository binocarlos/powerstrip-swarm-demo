...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.box_url = "http://storage.googleapis.com/experiments-clusterhq/orchestration-demos/powerstrip-swarm-demo-v3.box"
  config.vm.box = "powerstrip-swarm-demo-v3"
